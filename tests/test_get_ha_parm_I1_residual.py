...
def test_get_ha_parm_i1_residual_returns_positive_value() -> None:
...
def test_get_ha_parm_i1_residual_matches_stata(
    tmp_path: Path,
    ...
    py_value = get_ha_parm_I1_residual(om_ho, distmat, R, emat, M)
